...
We separate our population into two parts: those that speak English well (responding <i>ENG = 1</i> or <i>ENG = 2</i>) and those that do not speak English well (responding <i>ENG = 3</i> or <i>ENG = 4</i>). We then counted the number of immigrants who entered the US from 1920 until 2013. The two populations had similar trends in the years of immigration. After 1960

The number started to rise quickly after 1960. Some immigration tides appear around the years 1980, 1990 and 2000.

```{r, message=FALSE, warning=FALSE, results='hide'}
Time_Series(population_abov)
```

How about the gender ratio in the immigrants? We separate the immigration year into immigration decades. First, the histogram shows clearly the quick increase of immigrants' number. Then, regardless of number, females always beat male in amount, especially before 1950s, 61.0% of female vs. 40% of male.
...
```{r, message=FALSE, warning=FALSE, results='hide'}
source("lib/sri2116_functions_edits_noRN.R")
...
Now that we know what languages immigrants speak in their home, lets take a general look at how they report their English speaking ability. Over 65% of people think their English is "very well"" or "well". However, approximately 10.5% of the immigrants can't speak English at all!
...
Above we determined the most populous immigrant states, and we assessed their general speaking abilities. Below, this barplot shows how people who reside in these states vary in their ability to speak to English.
...
Let's seperate the population into two parts: Speaking English Well (Eng = 1 or 2) and Speaking English Not Well (Eng = 3 or 4). Then we count the number of immigrants with respect to years. The trends of the two group are quit similar. The number started to rise quickly after 1960. Some immigration tides appear around the years 1980, 1990 and 2000.
...
We also calculated the ages when immigrants entered, using the age and year of entry variables. We plot the stacked bar. It seems that people tend to immigrate at their early years. Around three quarters of people immigrate before the age of 30. However, note that their is a bias for the statistics, especially for early years such as before 1950s. You can see no components beyond 30s in the first bar. That doesn't mean all the immigrants are young people. The reason is in the year 2013, people who immigrated beyond their 30s before 1950s have passed away.
